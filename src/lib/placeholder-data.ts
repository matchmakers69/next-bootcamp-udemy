...
export type RestaurantIdMap = Record<string, number>;
...
export const itemsData = [
	{
		restaurantName: "Vivaan - fine Indian",
		data: [
			{
	...
	{
		restaurantName: "RamaKrishna Indian",
		data: [
			{
	...
	{
		restaurantName: "Last Train to Delhi",
		data: [
			{
				name: "Aloo Tiki",
	...
	{
		restaurantName: "Adrak Yorkville",
		data: [
			{
				name: "murgh salaad",
	...
	{
		restaurantName: "Curryish Tavern",
		data: [
			{
	...
	{
		restaurantName: "Kamasutra Indian",
		data: [
			{
	...
	{
		restaurantName: "Cano Restaurant",
		data: [
			{
				name: "Hamachi",
				description:
