					...
					<div className="w-[70%] rounded bg-white p-3 shadow">
						...
						<div className="mt-4">
							<p className="text-lg font-light">
								The classics you love prepared with a perfect twist, all served up in an atmosphere that feels
								just right. That's the Milestones promise. So, whether you're celebrating a milestone, making
								the most of Happy Hour or enjoying brunch with friends, you can be sure that every Milestones
						...
						{/* IMAGES */} {/* REVIEWS */}
						<div>
							<h1 className="borber-b mb-7 mt-10 pb-5 text-3xl font-bold">What 100 people are saying</h1>
							<div>
								{/* REVIEW CARD */}
